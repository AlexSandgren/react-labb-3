interface IStatData {
    statData: [
        { stat: { name: 'hp' }; base_stat: number },
        { stat: { name: 'attack' }; base_stat: number },
        { stat: { name: 'defense' }; base_stat: number },
        { stat: { name: 'special-attack' }; base_stat: number },
        { stat: { name: 'special-defense' }; base_stat: number },
        { stat: { name: 'speed' }; base_stat: number }
    ]
}
